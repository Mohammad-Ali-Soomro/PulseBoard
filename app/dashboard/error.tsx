      ...
      <main className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="max-w-md w-full bg-background-deep border border-border-hairline-soft rounded-card p-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3">
            <button
              onClick={() => reset()}
              className="w-full inline-flex items-center justify-center gap-2 px-5 py-3 text-sm font-bold text-ink bg-brand border border-border-hairline rounded-btn hover:bg-brand-hover transition-all cursor-pointer"
            >
